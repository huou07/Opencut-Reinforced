...
This is the canonical high-level architecture. Phase 3's executable bootstrap skeleton and Phase 4A–4E1 project/application foundations are implemented; planned and future components below do not imply implemented code. See [ROADMAP.md](ROADMAP.md) for phases and [TECHNICAL_PLAN.md](TECHNICAL_PLAN.md) for subsystem detail.
